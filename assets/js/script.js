...
const numbersDict = {
  ...
  C: [
    "M56.6 -48.9C52.9 -58.3 46 -63.2 35.8 -63.2C18.7 -63.2 9.5 -49.6 9.5 -29.3C9.5 -6.9 20.8 4.8 35.8 4.8C47.5 4.8 55.2 -2.3 58 -10.5",
  ],
  D: [
    "M14 1L14 67",
    "M14 1L26 1C44 1 60.7 10.3 60.8 33.9C60.9 54.3 48.4 67 28.7 67L14 67",
  ],
  E: ["M14 1L14 67", "M14 1 L50.1 1", "M14 35.6L48.4 35.6", "M14 67L50.1 67"],
  F: ["M14 1L14 67", "M14 1 L50.1 1", "M14 35.6L48.4 35.6"],
  G: [
    "M56.6 -48.9C52.9 -58.3 46 -63.2 35.8 -63.2C19.6 -63.2 9.5 -50.8 9.5 -29.2C9.5 -10.4 16.9 4.8 36.3 4.8C44.3 4.8 50.9 2.2 56 -0.9L56 -28.6L38.3 -28.6",
  ],
  H: ["M14 0L14 68", "M14 36.5L56.6 36.5", "M56.6 0L56.6 68"],
  I: ["M14 0v68"],
  J: ["M23.1 -63.2L23.1 -9C23.1 1.3 18.5 4.8 12.8 4.8C10.3 4.8 7.3 4.1 5 1.9"],
  K: ["M18.1 -63.2 L18.1 4.8", "M50.3 -63.2L19.1 -31.1L52.7 4.8"],
  L: ["M14 -63.2L14 3.8L45.8 3.8"],
  M: [
    "M14 4.8L14 -62.7L14.4 -62.7L42.9 1.8L43.3 1.8L71.8 -62.7L72.2 -62.7L72.2 4.8",
  ],
  N: ["M14 4.8L14 -62.7L14.4 -62.7L59.6 4.3L60 4.3L59.9 -63.2"],
  O: [
    "M35.7 -63.2C16.8 -63.2 9.5 -45.3 9.5 -29.3C9.5 -15.9 14.7 4.8 35.8 4.8S62.1 -15.9 62.1 -29.3C62.1 -45.3 54.8 -63.2 35.9 -63.2",
  ],
  P: [
    "M14 -62.2 L14 4.8",
  ...
  S: [
    "M45.6 -54.2C43.2 -59.4 37.9 -63.2 29.3 -63.2C17.1 -63.2 10.9 -55.7 10.9 -47.8C10.9 -28.6 47.6 -31.6 47.6 -11.5C47.6 -2.6 40.4 4.8 28.5 4.8C19.3 4.8 12.3 0.5 9.5 -6.1",
  ],
  T: ["M4 -62.2L48 -62.2", "M26 -62.2 L26 4.8"],
  U: [
    "M13 -63.2L13 -19.7C13 -3.9 21.8 4.8 34.7 4.8C48.2 4.8 56.4 -3.9 56.4 -19.7L56.4 -63.2 L56.4 4.8",
  ],
  V: ["M7 -63.2L31.9 4.3L32.3 4.3L57.1 -63.2"],
  W: [
    "M8 -63.2L25.5 4.3L25.9 4.3L45 -62.2L45.4 -62.2L64.5 4.3L64.9 4.3L83 -63.2",
  ],
...
function initiateExercise() {
  ...
  endButton.addEventListener("click", function () {
    ...
    gameIsActive = false;
    gameEnd();
    //TODO: This should pause the game, then allow to resume or end.
  });
  ...
  function balloonGame() {
    ...
    function generateBalloons() {
      ...
      if (!hasChosenLetter) {
        ...
        chosenSnowFlake.getElementsByTagName("span")[0].textContent =
          chosenLetter;
  ...
  function writeGame() {
    ...
    function drawPath(pathData, key) {
      const newGroup = gameContainer
        .append("svg") // Create a new SVG element for each letter
        .attr("id", "svgGroup" + key)
        .attr("class", "svg-group")
        .attr("preserveAspectRatio", "xMidYMid meet");

      // Create groups within the SVG element
      const backgroundGroup = newGroup
        .append("g")
        .attr("id", "backgroundGroup");
      const shapeLinesGroup = newGroup
        .append("g")
        .attr("id", "shapeLinesGroup");
      const foregroundGroup = newGroup
        .append("g")
        .attr("id", "foregroundGroup");

      groupList.push(newGroup);

      pathData.forEach((path, i) => {
        // Append path to the baseShapes group
        const newPath = backgroundGroup
          .append("path")
          .attr("id", "shape" + i)
          .attr("class", "shape")
          .attr("d", path)
        ...
        // Append path to the shapeLines group
        const newPathLine = shapeLinesGroup
          .append("path")
          .attr("id", "shapeLine" + i)
          .attr("class", "shapeLine")
          .attr("d", path)
          .attr("stroke", "#D9AE30")
          .attr("stroke-width", "1px")
          .attr("fill", "none");

        pathLineList.push(newPathLine);

        // Append path to the baseShapes group (for line)
        const newLine = foregroundGroup
          .append("path")
          .attr("id", "line" + i)
          .attr("fill", "none")
          .attr("d", path)
    ...
    function animatePath() {
      ...
      pathList.forEach((currentPath, i) => {
        ...
        const pauseDuration =
          i === 0
            ? 0
            : pathList[i - 1].node().getTotalLength() / animationSpeed;
    ...
    groupList.forEach((group) => {
      ...
      const widthPercentage =
        ((groupBBox.width + circleSize + 10) / totalWidth) * 100;
    ...
    function selectPath() {
      ...
      circle = createCircle();
      circle
        .attr("x", startPoint.x - circleSize / 2)
        .attr("y", startPoint.y - circleSize / 2);

      pathLineList[currentPath].node().classList.toggle("active");
      pathLineList[currentPath].node().style.strokeDashoffset = pathLength;
      disableDragging();
    }
    ...
    function pointModifier(point, circle) {
      ...
      if (fillpercentage > 0.95) {
        ...
        circle
          .attr("x", fullPoint.x - circleSize / 2)
          .attr("y", fullPoint.y - circleSize / 2);
        ...
        circle
          .attr("x", p.point.x - circleSize / 2)
          .attr("y", p.point.y - circleSize / 2);
      }
    }
